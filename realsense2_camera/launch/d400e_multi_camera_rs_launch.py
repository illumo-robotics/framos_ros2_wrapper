...
def generate_launch_description():
    params1 = duplicate_params(d400e_rs_launch.configurable_parameters, '1')
    params2 = duplicate_params(d400e_rs_launch.configurable_parameters, '2')
    if (os.getenv('ROS_DISTRO') == "dashing") or (os.getenv('ROS_DISTRO') == "eloquent"):
        return LaunchDescription(
            d400e_rs_launch.declare_configurable_parameters(local_parameters) +
            d400e_rs_launch.declare_configurable_parameters(params1) + 
            d400e_rs_launch.declare_configurable_parameters(params2) + 
            [
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource([ThisLaunchFileDir(), '/d400e_rs_launch.py']),
